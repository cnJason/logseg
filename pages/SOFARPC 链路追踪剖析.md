...
- ![image.png](../assets/image_1652776930372_0.png)
- ## 3.4 数据采样设计
...
- ![image.png](../assets/image_1652777015101_0.png)
...
- ![image.png](../assets/image_1652777076492_0.png)
...
- 1. 作为公共基础的通讯组件，SOFARPC的链路追踪埋点对业务代码实现零侵入。
  ...
  采用了自适应采样设计，巧妙平衡了数据采集和性能的问题。
  支持数据上报zipkin, 通过与zipkin结合可以快速构建一个完整的连续追踪系统。
  解决了异步线程链路调用数据问题。
  采用了OpenTracing 规范，因此可以和其他链路追踪收集和展示的技术框架快速整合。
-