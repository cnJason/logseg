...
- ##### 2、DFA-CRC负载均衡故障转移
- ![image.png](../assets/image_1652863807385_0.png)
- 在使用 DFA-CRC 作为注册中心时，故障的发现是由 CRC去进行发现，业务逻辑层通过 Watch 的心跳机制将自己注册到 ZK 上，网关对 ZK 进行订阅就可以知道有多少可以调用的列表。
...
- ![image.png](../assets/image_1652863876887_0.png)
...
- ![image.png](../assets/image_1652863907847_0.png)
